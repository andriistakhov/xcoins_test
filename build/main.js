...
var LoginPage = (function () {
    function LoginPage(navCtrl, navParams, apiService, formBuilder, translate, screenOrientation, platform, storage, appCtrl, events) {
        ...
        this.overlayPicVisibility = 'visible';
    ...
    LoginPage.prototype.isPlaying = function (event) {
        ...
        if (event === 'playing') {
            this.overlayPicVisibility = 'invisible';
        }
        else {
            this.overlayPicVisibility = 'visible';
        }
    ...
    // ngAfterContentInit(){
    //   let video = (<HTMLVideoElement>document.getElementById("bgvid")),
    //         timeToStop = 2;
    //         if (video.paused) {
    //           this.overlayPicVisibility = 'invisible';
    //           // this.play();
    ...
    //         // setTimeout(() => {
    //         //   console.log("video current time", video.currentTime);
    //         //   console.log("In time oyt", video.paused)
    //         //   // this.isLoginAvaible();
    //         // }, 200);
    //         // if(video.paused){
    ...
    //       // console.log("video current time", this.currentTime);
...
LoginPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["n" /* Component */])({
        ...
        animations: [
            ...
            Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["_33" /* trigger */])('overlayPic', [
                ...
                Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["_32" /* transition */])('visible <=> invisible', Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["_19" /* animate */])('100ms ease-out')),
            ]),
